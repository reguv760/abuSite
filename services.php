...
<div id="container">
    ...
    <div id="content" style="background-image:url('assets/abuMain.jpg');">
        ...
        <div id="contentHolder">
        	<span class="pageHeader">Services</span><br/>
            <br/>
        	<p>Abraham Lim specializes and handles cases which involves US Immigration law. This includes:</p>
            <ul class="services">
                <li>EB -5 INVESTMENT VISA</li>
                <li>EB-2 PERM</li>
                <li>LABOR CERTIFICATIONS</li>
                <li>E1/E2 VISA</li>
                <li>O-1 EXTRAORDINARY ABILITY ALIENS</li>
                <li>P ARTIST VISA</li>
                <li>Q VISITOR VISA</li>
                <li>L1 VISA</li>
                <li>H-1B VISA</li>
                <li>TN VISA</li>
                <li>MARRIAGE & FAMILY CASES</li>
                <li>BATTERED SPOUSE CASES</li>
                <li>DEPORTATION DEFENSE</li>
                <li>CRIMINAL DEPORTATION</li>
                <li>IMMIGRATION WORKSITE COMPLIANCE</li>
            </ul>

            <p>Abraham Lim also practices:
            <ul class="services">
